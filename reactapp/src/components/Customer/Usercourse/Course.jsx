            ...
            <Row xl={1} lg={1} md={1} xs={1} className="h-100 d-flex flex-column align-items-center justify-content-center">
                {
                    courseList.filter((item) => {
                        ...
                        return (
                            <Col key={index}>
                                <CourseCard name={item.courseName} description={item.courseDescription} duration={item.courseDuration} students={item.courseEnrolled} timings={item.courseTiming} courseId={item.courseId} />
                            </Col>
                        )
                    })
                }
